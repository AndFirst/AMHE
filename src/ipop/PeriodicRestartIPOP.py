...
class PeriodicRestartIPOP(OptimizerWrapper):
    def __init__(self, optimizer_class, objective_function,
                 ...
                 restart_interval=100, pop_increase_factor=2,
                 population_size=None, dim=None):
        """
        IPOP-style restart after a fixed number of iterations.
        ...
        Args:
            ...
            restart_interval: number of iterations before forced restart
    ...
    def run(self, max_iterations=1000, fitness_threshold=-np.inf):
        ...
        for _ in range(max_iterations):
            ...
            if iteration_counter >= self.restart_interval:
